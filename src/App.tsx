...
const translations = {
  ja: {
    ...
    hero: {
      ...
      bio: 'データを分析し、AIを実装し、グローバルチームを率いる。複雑な課題をシンプルな意思決定へ変換します。',
      quote: '「データは道を照らす。最後に決めるのは、人間の情理だ。」',
      experience: '経験領域',
    ...
    about: {
      title: 'プロフィール',
      tagline: 'データが戦略を導く。\nAIが実行を加速する。\nリーダーシップが実現させる。\n意思決定は、いつも人間のもの。',
      p1: '外資金融、大手システムインテグレーター、そして生成AIエンジニアとしての経験を通じ、テクノロジーとビジネスの架け橋となるプロジェクトを推進してきました。',
      p2: 'ロンドンでのクレジットアナリスト経験や、欧州5カ国を跨ぐグローバルプロジェクトのマネジメントなど、多様な文化と業界での経験が、私の多角的な視点を形作っています。',
      p3: '現在はフリーランスとして、AIエンジニアメンターやデータ分析アドバイザーとして活動しています。データは強力な道具ですが、最後に意思決定するのは人間です。論理と感性——情理のバランスを大切に、クライアントの判断を支援します。',
      coreSkills: 'コアスキル',
      location: '拠点',
    },
    capabilities: {
    ...
    contact: {
      title: 'コンタクト',
      body: 'データ戦略、AIエンジニアリング、リーダーシップに関するご相談をお待ちしています。あなたのビジネスに「自分らしさ」と「効率」を。',
      reply: '24時間以内にご返信します。',
      cta: 'お問い合わせはこちら →',
    },
