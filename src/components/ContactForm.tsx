...
const copy = {
  ja: {
    ...
    inquiryOptions: [
      ...
      { value: 'genai',      label: '生成AI開発・実装' },
      { value: 'data',       label: 'データ分析アドバイザリー' },
      { value: 'automation', label: 'ノーコード/ローコード自動化' },
      { value: 'project',    label: 'プロジェクトマネジメント・アプリ開発' },
      { value: 'training',   label: '生成AI研修・メンタリング' },
  ...
  en: {
    ...
    inquiryOptions: [
      ...
      { value: 'genai',      label: 'GenAI Engineering' },
      { value: 'data',       label: 'Data Analytics Advisory' },
      { value: 'automation', label: 'No-Code / Low-Code Automation' },
      { value: 'project',    label: 'Project Management & App Development' },
      { value: 'training',   label: 'GenAI Training & Mentoring' },
